...
const RegisterPage = () => {
  ...
  const InputField = ({ icon: Icon, label, name, type, placeholder, rightEl, autoComplete }) => (
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`input-field !pl-9 ${rightEl ? '!pr-10' : ''} ${errors[name] ? 'border-red-400 focus:ring-red-400/30' : ''}`}
        />
        {rightEl && (
          <button
            type="button"
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 relative overflow-hidden flex-col justify-between p-12">
        ...
        <p className="relative text-slate-600 text-sm">© 2026 Weero Digital.</p>
      </div>
        ...
        <div className="w-full max-w-sm animate-slide-up py-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <InputField
              ...
              type="text" placeholder="Kabir Hossain" autoComplete="name"
            />
            <InputField
